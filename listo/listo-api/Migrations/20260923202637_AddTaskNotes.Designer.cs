...
namespace Listo.Api.Migrations
{
    ...
    [Migration("20260923202637_AddTaskNotes")]
    partial class AddTaskNotes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Listo.Api.Models.AccountCard", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("BackImageMimeType")
                        .HasColumnType("longtext")
                        .HasColumnName("back_image_mime_type");
                    ...
                    b.Property<string>("FrontImageMimeType")
                        .HasColumnType("longtext")
                        .HasColumnName("front_image_mime_type");
                    ...
                    b.ToTable("account_cards", (string)null);
                });
            ...
            modelBuilder.Entity("Listo.Api.Models.AudioStream", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Listo.Api.Models.ConversationParticipant", b =>
                {
                    ...
                    b.Property<long?>("LastNotifiedMessageSysId")
                        .HasColumnType("bigint")
                        .HasColumnName("last_notified_message_sys_id");
            ...
            modelBuilder.Entity("Listo.Api.Models.DashboardLayout", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Listo.Api.Models.PasswordCategory", b =>
                {
                    ...
                    b.ToTable("password_categories", (string)null);
                });

            modelBuilder.Entity("Listo.Api.Models.PasswordEntry", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("CategorySysId")
                        .HasColumnType("bigint")
                        .HasColumnName("category_sys_id");
                    ...
                    b.HasIndex("CategorySysId");

                    b.HasIndex("UserSysId");

                    b.ToTable("password_entries", (string)null);
                });
            ...
            modelBuilder.Entity("Listo.Api.Models.PeriodLog", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("IsStartDateEstimated")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("is_start_date_estimated");
                    ...
                    b.Property<DateTime?>("PreWeekStartDate")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("pre_week_start_date");
                    ...
                    b.ToTable("period_logs", (string)null);
                });

            modelBuilder.Entity("Listo.Api.Models.PeriodLogEntry", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("EntryTypeSysId")
                        .HasColumnType("bigint")
                        .HasColumnName("entry_type_sys_id");
                    ...
                    b.Property<long>("PeriodLogSysId")
                        .HasColumnType("bigint")
                        .HasColumnName("period_log_sys_id");

                    b.HasKey("SysId");

                    b.HasIndex("EntryTypeSysId");

                    b.HasIndex("PeriodLogSysId");

                    b.ToTable("period_log_entries", (string)null);
                });

            modelBuilder.Entity("Listo.Api.Models.PeriodLogEntryType", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("period_log_entry_types", (string)null);
                });
            ...
            modelBuilder.Entity("Listo.Api.Models.ScratchNote", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("ConvertedTaskSysId")
                        .HasColumnType("bigint")
                        .HasColumnName("converted_task_sys_id");
                    ...
                    b.ToTable("scratch_notes", (string)null);
                });
            ...
            modelBuilder.Entity("Listo.Api.Models.TaskBoard", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Listo.Api.Models.TaskBoardColumn", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("TaskBoardSysId")
                        .HasColumnType("bigint")
                        .HasColumnName("task_board_sys_id");

                    b.HasKey("SysId");

                    b.HasIndex("TaskBoardSysId");

                    b.ToTable("task_board_columns", (string)null);
                });

            modelBuilder.Entity("Listo.Api.Models.TaskItem", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("TaskBoardColumnSysId")
                        .HasColumnType("bigint")
                        .HasColumnName("task_board_column_sys_id");
                    ...
                    b.HasIndex("TaskBoardColumnSysId");
            ...
            modelBuilder.Entity("Listo.Api.Models.TaskNote", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("TaskItemSysId")
                        .HasColumnType("bigint")
                        .HasColumnName("task_item_sys_id");

                    b.HasKey("SysId");

                    b.HasIndex("TaskItemSysId");
            ...
            modelBuilder.Entity("Listo.Api.Models.TrustedDevice", b =>
                {
                    b.Property<long>("SysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Listo.Api.Models.User", b =>
                {
                    ...
                    b.Property<string>("PushoverKey")
                        .HasColumnType("longtext")
                        .HasColumnName("pushover_key");
            ...
            modelBuilder.Entity("Listo.Api.Models.PasswordEntry", b =>
                {
                    b.HasOne("Listo.Api.Models.PasswordCategory", "Category")
                        .WithMany("PasswordEntries")
                        .HasForeignKey("CategorySysId")
            ...
            modelBuilder.Entity("Listo.Api.Models.PeriodLogEntry", b =>
                {
                    b.HasOne("Listo.Api.Models.PeriodLogEntryType", "EntryType")
                        .WithMany("Entries")
                        .HasForeignKey("EntryTypeSysId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Listo.Api.Models.PeriodLog", "PeriodLog")
                        .WithMany("Entries")
                        .HasForeignKey("PeriodLogSysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EntryType");

                    b.Navigation("PeriodLog");
                });
            ...
            modelBuilder.Entity("Listo.Api.Models.TaskBoardColumn", b =>
                {
                    b.HasOne("Listo.Api.Models.TaskBoard", "TaskBoard")
                        .WithMany("Columns")
                        .HasForeignKey("TaskBoardSysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Listo.Api.Models.TaskItem", b =>
                {
                    b.HasOne("Listo.Api.Models.TaskBoardColumn", "TaskBoardColumn")
                        .WithMany("Tasks")
                        .HasForeignKey("TaskBoardColumnSysId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("TaskBoardColumn");
                });

            modelBuilder.Entity("Listo.Api.Models.TaskNote", b =>
                {
                    b.HasOne("Listo.Api.Models.TaskItem", "TaskItem")
                        .WithMany()
                        .HasForeignKey("TaskItemSysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
